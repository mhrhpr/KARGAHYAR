...
export default function Expenses(){
  ...
  return <SafeAreaView style={{flex:1,backgroundColor:BRAND.bg,padding:20}}><ScrollView contentContainerStyle={{paddingBottom:40}}>
    <Pressable onPress={()=>router.back()}><Text style={{color:BRAND.muted}}>← بازگشت</Text></Pressable><Text style={{color:BRAND.text,fontSize:29,fontWeight:"900",marginTop:12}}>هزینه‌های پروژه</Text>
...
const styles=StyleSheet.create({input:{backgroundColor:BRAND.bg,color:BRAND.text,padding:15,borderRadius:13,borderWidth:1,borderColor:BRAND.border},primary:{backgroundColor:BRAND.accent,padding:15,borderRadius:13},primaryText:{color:"#fff",textAlign:"center",fontWeight:"900"},card:{backgroundColor:BRAND.surface,borderWidth:1,borderColor:BRAND.border,borderRadius:17,padding:17},title:{color:BRAND.text,fontSize:17,fontWeight:"800"},amount:{color:BRAND.text,fontWeight:"900"},sub:{color:BRAND.muted,marginTop:5}};
